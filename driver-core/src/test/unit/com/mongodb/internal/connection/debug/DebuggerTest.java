...
public final class DebuggerTest {
    ...
    @SuppressWarnings("try")
    public void useReportingModeConcurrently() {
        try (OverridingReportingMode ignore = Debugger.useReportingMode(ReportingMode.LOG)) {
            Debugger.useReportingMode(ReportingMode.LOG);
        }
        assertSame(ReportingMode.OFF, Debugger.reportingMode());
    }
    ...
    @Test(expected = AssertionError.class)
    @SuppressWarnings("try")
    public void useReportingModeConcurrently2() {
        try (OverridingReportingMode ignore = Debugger.useReportingMode(ReportingMode.LOG)) {
            Debugger.useReportingMode(ReportingMode.LOG_AND_THROW);
        }
        assertSame(ReportingMode.OFF, Debugger.reportingMode());
    }
    ...
    @Test
    public void toStringThrowable2() {
        Throwable t = new MongoDebuggingException("testMessage");
